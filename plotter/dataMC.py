...
labels = {
    ...
    'eta1': ["|#eta_{leading jet}|","Events / 0.1"],
    'eta2': ["|#eta_{trailing jet}|","Events / 0.1"],
    'eta3': ["|#eta_{2trailing jet}|","Events / 0.1"],
    'eta4': ["|#eta_{3trailing jet}|","Events / 0.1"],
...
def main():
    ...
    bkgs=[DYjetsNLO,zgamma,tt,ttgamma,wwgamma,wzgamma,zz,wjets,wgamma,singletop,zz4l,ww,wz]
    ...
    variables=["eta1","pt1","n_jets","n_vtx","phi1","m_ll","ht","n_photons","pt_g1","nElectrons","nMuons","deltaR1_g1","deltaR2_g1","deltaRLL"]
...
def main3():
    ...
    variables=["eta1","pt1","n_jets","n_vtx","phi1","m_ll","ht","n_photons","pt_g1","met","deltaRLL","deltaR1_g1","deltaR2_g1"]
    groups=["onZMet0100"]
    for group in groups:
        for variable in variables:
            drawSameHistogram("EE",group+"/EE/"+variable, bkgs, additional=[dataDoubleEG],binning=binnings[variable],xTitle=labels[variable][0])
