...
def drawSameHistogram( sampleNames, name, bkg=[], additional=[], binning=None, binningName="", scaleToData=False, xTitle=None, yTitle=None ):
    ...
    if m.Draw():
        ...
        aux.save("DataMC_"+saveName,folder="plots_CutFlow/" ,changeMinMax=True)
...
def main():
    ...
    bkgs=[zgamma,DYjetsNLO,tt,ttgamma,wwgamma,wzgamma,zz,wjets,wgamma,wjets,zz4l,ww,wz]
    ...
    for group in groups:
        for variable in variables:
            drawSameHistogram("EE+Data",group+"EE/"+variable, bkgs, additional=[dataDoubleEG])
            drawSameHistogram("MM+Data",group+"MM/"+variable, bkgs, additional=[dataDoubleMuon])
            drawSameHistogram("EM+Data",group+"EM/"+variable, bkgs, additional=[dataMuonEG])
            ...
            drawSameHistogram("EEsignal",group+"EE/"+variable, bkg=[], additional=[t5bbbbzg_1500_1400,t5bbbbzg_1500_400,t5bbbbzg_1500_600,tching_1200,tching_400])
            drawSameHistogram("MMsignal",group+"MM/"+variable, bkg=[], additional=[t5bbbbzg_1500_1400,t5bbbbzg_1500_400,t5bbbbzg_1500_600,tching_1200,tching_400])
            drawSameHistogram("EMsignal",group+"EM/"+variable, bkg=[], additional=[t5bbbbzg_1500_1400,t5bbbbzg_1500_400,t5bbbbzg_1500_600,tching_1200,tching_400])
