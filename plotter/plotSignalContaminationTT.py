...
gm.DrawLatexNDC(
    0.2, 0.85, "#scale[0.66]{#font[52]{t#bar{t}(#gamma) Control Region}}")
c.Update()
...
gm.DrawLatexNDC(
    0.2, 0.8, "#scale[0.66]{#font[52]{t#bar{t}(#gamma) Control Region}}")
c.Update()
...
gm.DrawLatexNDC(
    0.3, 0.2, "#scale[0.66]{#font[52]{t#bar{t}(#gamma) Control Region}}")
c.Update()
